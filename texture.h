...
class Texture {
    public:
        ...
        // Load texture from bitmap image
        bool LoadFromBitMapImage(std::string path, Uint8 r = 0, Uint8 g = 0, Uint8 b = 0);

        // Load texture from png image
        bool LoadFromPNGImage(std::string path, Uint8 r = 0, Uint8 g = 0, Uint8 b = 0);
